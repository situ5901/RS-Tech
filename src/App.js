...
const AnimatedSvg = () => {
  return (
    <>
      <img src={Linkedin} alt="" width={"150px"} height={"150px"} />
    </>
  );
};
  ...
  return (
    <>
      ...
      <Modal
        ...
        keyboard={true}
      >
        <Modal.Header closeButton style={{ backgroundColor: '#ffffff', color: 'black' }} >
          <Modal.Title id="example-modal-sizes-title-sm" styl e={{ color: 'black' }}>
            <div className="linkedin" style={{ display: "flex" }}>
              Connetc Linkedin
              <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="40" viewBox="0 0 48 48" style={{ marginTop: "-3" }} >
        ...
        <Modal.Body style={{ backgroundColor: '#01091b', color: 'white', padding: '20px', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
          <div className="pop" style={{ display: 'flex', alignItems: 'center' }}>
            ...
            <p style={{ marginLeft: '25px',marginRight:"25px", fontSize: '12px', textAlign: 'left', maxWidth: '300px', lineHeight: '1.5', wordSpacing: 'normal', letterSpacing: 'normal' }}>
              Connect with RS-Tech by scanning the QR code and transform your innovative ideas into reality using cutting-edge technology. Our team specializes in leveraging the latest advancements to bring your concepts to life with precision and creativity. Join us on a journey of technological innovation and excellence.
            </p>
          </div>
        </Modal.Body>
